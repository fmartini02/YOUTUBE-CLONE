...
- [ ] **Feed iscrizioni veloce (cookie)** — con i cookie, una volta che una copia del feed esiste
      (`data/subscriptions_cookie_feed_cache.json`), `GET /api/feed/subscriptions` risponde in
