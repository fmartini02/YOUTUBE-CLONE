...
4. **Porta 8090 cambiata in un punto solo**: deve restare allineata in `main.py`, `frontend/vite.config.js`, `electron/main.js`, `start_server.sh`/`.bat`, `Dockerfile`, `docker-compose.yml`.
